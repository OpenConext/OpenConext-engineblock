...
class Version20180202131013 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE saml_persistent_id (persistent_id CHAR(40) NOT NULL COLLATE utf8_unicode_ci COMMENT \'SHA1 of service_provider_uuid + user_uuid\', user_uuid CHAR(36) NOT NULL COLLATE utf8_unicode_ci, service_provider_uuid CHAR(36) NOT NULL COLLATE utf8_unicode_ci, INDEX user_uuid (user_uuid, service_provider_uuid), PRIMARY KEY(persistent_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service_provider_uuid (uuid CHAR(36) NOT NULL COLLATE utf8_unicode_ci, service_provider_entity_id VARCHAR(1024) NOT NULL COLLATE utf8_unicode_ci, INDEX service_provider_entity_id (service_provider_entity_id), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
