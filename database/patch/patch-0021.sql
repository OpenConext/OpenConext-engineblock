-- Create sso_provider_roles for PUSH metadata
DROP TABLE sso_provider_roles;
CREATE TABLE sso_provider_roles (
  ...
  organization_nl_name                LONGTEXT     DEFAULT NULL COMMENT '(DC2Type:object)',
  organization_en_name                LONGTEXT     DEFAULT NULL COMMENT '(DC2Type:object)',
  ...
  single_logout_service               LONGTEXT     DEFAULT NULL COMMENT '(DC2Type:object)',
  ...
  response_processing_service_binding VARCHAR(255) DEFAULT NULL,
