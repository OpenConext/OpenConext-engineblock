...
return $overrides + [
    ...
    'value'                 => 'Waarde',
    'post_data'             => 'POST Data',
    'processing'            => 'Verbinden met de applicatie',
    'processing_waiting'    => 'Wachten op een reactie van de applicatie.',
    'processing_long'       => 'Wees a.u.b. geduldig, het kan even duren...',
    'go_back'               => '&lt;&lt; Ga terug',
    'note'                  => 'Mededeling',
    'note_no_script'        => 'Jouw browser ondersteunt geen JavaScript. Gebruik de onderstaande knop om door te gaan.',
...
HTML
    ...
    // Footer
    'service_by'            => 'Deze applicatie is verbonden via',
    ...
    // Request Access Form
    'request_access_instructions_head' => 'Helaas, je hebt geen toegang tot de applicatie die je zoekt. Wat nu?',
    'request_access_instructions_text' => 'Wil je toch graag toegang tot deze applicatie, vul dan het onderstaande formulier in.
    ...
    'send_confirm_desc'     => 'Je verzoek is doorgestuurd naar de juiste persoon binnen jouw %organisationNoun%. Het is aan deze persoon om actie te ondernemen op basis van jouw verzoek. Het kan zijn dat er nog afspraken gemaakt moeten worden tussen jouw %organisationNoun% en de applicatieaanbieder.',
    ...
    'consent_no_attributes_text'              => 'Voor deze applicatie zijn geen gegevens van jouw %organisationNoun% nodig.',
    ...
    'error_return-sp-link-text-short' => 'Terug naar applicatie',
    ...
    'error_no_idps_desc_no_sp_name'                => 'Inloggen op de applicatie via %suiteName% is onmogelijk. De applicatie is niet gekoppeld met een %organisationNoun%.',
    'error_session_lost'                => 'Fout - Sessie is verloren gegaan',
    'error_session_lost_desc'           => 'Om verder te gaan naar de applicatie heb je een actieve sessie nodig, maar deze is verlopen. Heb je misschien te lang gewacht met inloggen? Ga terug naar de applicatie en probeer het nog een keer. Als dat niet werkt, sluit je browser af en probeer nogmaals opnieuw in te loggen.',
    'error_session_not_started'                => 'Fout - Geen sessie gevonden',
    'error_session_not_started_desc'           => 'Om verder te gaan naar de applicatie heb je een actieve sessie nodig, maar we kunnen deze niet vinden. Je browser moet cookies ondersteunen. Ook kan de link die je hebt gebruikt om bij de applicatie te komen, verkeerd zijn. Ga terug naar de applicatie en probeer het opnieuw. Als dat niet werkt, probeer een andere browser.',
    'error_unsolicited_response'      => 'Fout - Inloggen niet gelukt',
    'error_unsolicited_response_desc' => 'Inloggen is niet gelukt, omdat het een niet-ondersteunde manier is gestart. Je bent rechtstreeks naar deze applicatie gestuurd door je identiteitsverstrekker (bijvoorbeeld via een bladwijzer, portaaltegel of opgeslagen koppeling), in plaats van in te loggen vanuit de applicatie. Dit wordt niet ondersteund. Begin opnieuw vanuit de applicatie die je wil gebruiken en log in via die weg.',
    ...
    'error_authorization_policy_violation_desc_no_sp_name'       => 'Neem contact op met de helpdesk van %idpName% als je toegang tot deze applicatie wilt. Vermeld daarbij op welke applicatie je probeerde in te loggen en dat je werd tegengehouden door een autorisatieregel van %suiteName%, geconfigureerd door %idpName%.',
    'error_authorization_policy_violation_desc_no_name'       => 'Neem contact op met de helpdesk van je eigen %organisationNoun% als je toegang tot deze applicatie wilt. Vermeld daarbij op welke applicatie je probeerde in te loggen en dat je werd tegengehouden door een autorisatieregel van %suiteName%, geconfigureerd door jouw eigen %organisationNoun%.',
    ...
    'error_unknown_keyid_desc' => 'De gevraagde key-ID is niet bekend bij %suiteName%. Wellicht gebruikt de applicatie achterhaalde metadata of is er sprake van een andere configuratiefout.',
    ...
    'error_unknown_service_provider_desc_no_sp_name' => 'De verzochte applicatie is onbekend bij %suiteName%. Wellicht heeft %idpName% toegang tot deze applicatie niet geactiveerd. Wil je gebruik maken van deze applicatie, wend je dan tot de helpdesk van %idpName%.',
    'error_unknown_service_provider_desc_no_idp_name' => '%spName% is onbekend bij %suiteName%. Wellicht heeft je %organisationNoun% toegang tot deze applicatie niet geactiveerd. Wil je gebruik maken van %spName%, wend je dan tot de helpdesk van je %organisationNoun%.',
    'error_unknown_service_provider_desc_no_names' => 'De verzochte applicatie is onbekend bij %suiteName%. Wellicht heeft je %organisationNoun% toegang tot deze applicatie niet geactiveerd. Wil je gebruik maken van deze applicatie, wend je dan tot de helpdesk van je %organisationNoun%.',
    ...
    'error_generic_desc_no_sp_name' => 'Inloggen is niet gelukt en we weten niet precies waarom. Probeer het eerst eens opnieuw door terug te gaan naar de applicatie en opnieuw in te loggen. Lukt dit niet, neem dan contact op met de helpdesk van %idpName%.',
    ...
    'error_generic_desc_no_names' => 'Inloggen is niet gelukt en we weten niet precies waarom. Probeer het eerst eens opnieuw door terug te gaan naar de applicatie en opnieuw in te loggen. Lukt dit niet, neem dan contact op met de helpdesk van je %organisationNoun%.',
    ...
    'error_received_error_status_code_desc'=> 'Je %organisationNoun% heeft je de toegang geweigerd tot deze applicatie. Neem contact op met de helpdesk van je eigen %organisationNoun% om te kijken of dit verholpen kan worden.',
    ...
    'error_stuck_in_authentication_loop_desc_no_sp_name' => 'Je bent succesvol ingelogd bij %idpName% maar de applicatie waar je naartoe wilt stuurt je weer terug naar %suiteName%. Omdat je succesvol bent ingelogd, stuurt %suiteName% je weer naar de applicatie, wat resulteert in een oneindig zwart gat. Dit komt waarschijnlijk door een foutje aan de kant van de applicatie.',
    'error_stuck_in_authentication_loop_desc_no_name' => 'Je bent succesvol ingelogd bij je %organisationNoun% maar de applicatie waar je naartoe wilt stuurt je weer terug naar %suiteName%. Omdat je succesvol bent ingelogd, stuurt %suiteName% je weer naar de applicatie, wat resulteert in een oneindig zwart gat. Dit komt waarschijnlijk door een foutje aan de kant van de applicatie.',
    'error_authentication_limit_exceeded' => 'Fout - Te veel gelijktijdige onafgeronde authenticaties.',
    ...
    'error_invalid_mfa_authn_context_class_ref_desc' => '%idpName% vereist multi-factor authenticatie voor deze applicatie. Je tweede factor kon echter niet gevalideerd worden. Neem contact op met de helpdesk van %idpName% om dit op te lossen.',
    'error_invalid_mfa_authn_context_class_ref_desc_no_idp_name' => 'Jouw %organisationNoun% vereist multi-factor authenticatie voor deze applicatie. Je tweede factor kon echter niet gevalideerd worden. Neem contact op met de helpdesk van je %organisationNoun% om dit op te lossen.',
    ...
    'error_unknown_requesterid_in_authnrequest'         => 'Error - Deze applicatie is niet geregistreerd bij %suiteName%.',
    'error_unknown_requesterid_in_authnrequest_desc'    => 'Deze applicatie is niet bekend.',
    ...
    'error_stepup_callout_unknown' => 'Fout - Onbekend probleem met de sterke authenticatie',
    'error_stepup_callout_unknown_desc' => 'Inloggen met sterke authenticatie is niet gelukt. Probeer het opnieuw door terug te gaan naar de applicatie en opnieuw in te loggen. Lukt dit niet, neem dan contact op met de helpdesk van je %organisationNoun%.',
    'error_stepup_callout_unmet_loa_title' => 'Fout - Geen geschikt token gevonden',
    'error_stepup_callout_unmet_loa_desc' => 'Om toegang te krijgen tot deze applicatie heb je een geregistreerd token nodig met een bepaald zekerheidsniveau. Je hebt nu ofwel geen token geregistreerd, of het zekerheidsniveau van het token dat je hebt geregistreerd is te laag. Volg de link hieronder voor meer informatie over het registratieproces.',
    ...
    'error_stepup_callout_user_cancelled_desc' => 'Je hebt het inloggen afgebroken. Ga terug naar de applicatie als je het opnieuw wilt proberen.',
