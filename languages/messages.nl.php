...
HTML
    ...
    // Error screens
    'error_feedback_info_intro' => '<span class="heading@small">Blijft deze foutmelding terugkomen?</span> Maak dan gebruik van de hieronder vermelde hulpopties. Vermeld bij contact met de helpdesk de onderstaande codes:',
    ...
    'error_unknown_preselected_idp' => 'Fout - %spName% niet toegankelijk via %idpName%',
    'error_unknown_preselected_idp_desc' => '%idpName% heeft de toegang tot %spName% niet geactiveerd. Dat betekent dat jij geen gebruik kunt maken van deze dienst via %suiteName%. Neem contact op met de helpdesk van %idpName% als je toegang wilt krijgen tot %spName%. Geef daarbij aan dat het om toegang krijgen tot %spName% via %suitename% gaat en waarom je toegang wilt.',
    'error_unknown_preselected_idp_no_idp_name' => 'Fout - %spName% niet toegankelijk via %organisationNoun%',
    'error_unknown_preselected_idp_desc_no_idp_name' => 'De %organisationNoun% waarmee je wilt inloggen heeft toegang tot %spName% niet geactiveerd. Dat betekent dat jij geen gebruik kunt maken van deze dienst via %suiteName%. Neem contact op met de helpdesk van jouw %organisationNoun% als je toegang wilt krijgen tot %spName%. Geef daarbij aan dat het om %spName% gaat en waarom je toegang wilt.',
