...
HTML
    ...
    'error_unknown_preselected_idp_no_sp_name' => 'Fout - Applicatie niet toegankelijk via %organisationNoun%',
    ...
    'error_unknown_service_provider_desc_no_sp_name' => 'De verzochte Service Provider is onbekend bij %suiteName%. Wellicht heeft %idpName% toegang tot deze applicatie niet geactiveerd. Wil je gebruik maken van deze applicatie, wend je dan tot de helpdesk van %idpName%.',
    ...
    'error_unknown_service_provider_desc_no_names' => 'De verzochte Service Provider is onbekend bij %suiteName%. Wellicht heeft je %organisationNoun% toegang tot deze applicatie niet geactiveerd. Wil je gebruik maken van deze applicatie, wend je dan tot de helpdesk van je %organisationNoun%.',
