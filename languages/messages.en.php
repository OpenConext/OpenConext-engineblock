...
HTML
    ...
    'error_authorization_policy_violation_desc'       => 'Please contact the service desk of %idpName% if you require access to %spName%. Be sure to mention you tried to access %spName% and that you were blocked by an authorization policy in %suiteName%, configured by %idpName%.',
    ...
    'error_unknown_preselected_idp' => 'Error - %spName% not accessible through %idpName%',
    'error_unknown_preselected_idp_desc' => '%idpName% did not activate access to %spName%. This means you are currently unable to use %spName% through %suiteName%. Please contact the service desk of %idpName% to request access. State it is about accessing %spName% through %suiteName% and why you need access.',
    'error_unknown_preselected_idp_no_idp_name' => 'Error - %spName% not accessible through your %organisationNoun%',
    'error_unknown_preselected_idp_desc_no_idp_name' => 'The %organisationNoun% that you want to use to login to %spName% did not activate access to it. This means you are unable to use %spName% through %suiteName%. Please contact the service desk of your %organisationNoun% to request access. State it is about %spName% and why you need access.',
