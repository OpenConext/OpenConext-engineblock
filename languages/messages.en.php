...
HTML
    ...
    'error_authorization_policy_violation_desc'       => 'Please contact the service desk of your own  %organisationNoun% if you require access to this service. Be sure to mention which service you tried to access and that you were blocked by an authorization policy in %suiteName%, configured by your own %organisationNoun%.',
