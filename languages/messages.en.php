...
Your %organisationNoun% has denied you access to this service. You will have to contact your own (IT-)servicedesk to see if this can be fixed.
    ...
    'error_sfo_callout_unknown_title' => 'Error - Unknown strong authentication failure',
    'error_sfo_callout_unknown_desc' => 'Logging in with strong authentication has failed and we don\'t know exactly why . Please try again first by going back to the service and logging in again . If this doesn\'t work, please contact the help desk of your %organisationNoun%.',
    'error_sfo_callout_unmet_loa_title' => 'Error - No suitable token found',
    'error_sfo_callout_unmet_loa_desc' => 'To continue to this service, a registered token with a certain level of assurance is required. Currently, you either haven\'t registered a token at all, or the level of assurance of token you did register is too low . See the link below for more information about the registration process.',
    'error_sfo_callout_user_cancelled_title' => 'Error - Logging in cancelled',
    'error_sfo_callout_user_cancelled_desc' => 'You have aborted the login process. Go back to the service if you want to try again.',
