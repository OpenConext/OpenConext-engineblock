...
A sua %organisationNoun% negou-lhe acesso a este serviço. Terá de entrar em contacto com o suporte (IT) para ver se é possível corrigir a situação.
    ...
    'error_sfo_callout_unknown_title' => 'Erro - falha de autenticação forte desconhecida',
    'error_sfo_callout_unknown_desc' => 'O login com autenticação forte falhou e não sabemos exatamente o motivo. Por favor, tente novamente primeiro voltando ao serviço e fazendo o login novamente. Se isso não funcionar, entre em contato com o suporte técnico do seu %organisationNoun%.',
    'error_sfo_callout_unmet_loa_title' => 'Erro - nenhum token adequado encontrado',
    'error_sfo_callout_unmet_loa_desc' => 'Para continuar nesse serviço, é necessário um token registrado com um certo nível de garantia. Atualmente, você não registrou um token, ou o nível de garantia do token que você registrou é muito baixo. Veja o link abaixo para mais informações sobre o processo de registro.',
    'error_sfo_callout_user_cancelled_title' => 'Erro - Logging cancelado',
    'error_sfo_callout_user_cancelled_desc' => 'Você cancelou o processo de login. Volte para o serviço se você quiser tentar novamente.',
