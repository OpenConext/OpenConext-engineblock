...
HTML
    ...
    'error_unknown_preselected_idp' => 'Erro - Não há ligação entre %idpName% e o serviço',
    'error_unknown_preselected_idp_desc' => 'A %idpName% que pretende utilizar para se autenticar e aceder ao serviço, não tem activado o acesso a este serviço. Isto significa que não pode aceder a este serviço através da %suiteName%. Entre em contacto com com o suporte da %idpName% para solicitar o acesso a este serviço. Declare que serviço se trata (o &lsquo;Fornecedor de Serviço&rsquo;) e porque necessita do acesso.',
    'error_unknown_preselected_idp_no_idp_name' => 'Erro - Não há ligação entre %organisationNoun% e o serviço',
    'error_unknown_preselected_idp_desc_no_idp_name' => 'A %organisationNoun% que pretende utilizar para se autenticar e aceder ao serviço, não tem activado o acesso a este serviço. Isto significa que não pode aceder a este serviço através da %suiteName%. Entre em contacto com com o suporte da sua %organisationNoun% para solicitar o acesso a este serviço. Declare que serviço se trata (o &lsquo;Fornecedor de Serviço&rsquo;) e porque necessita do acesso.',
    'error_unknown_service_provider'          => 'Erro - %spName% desconhecido',
    'error_unknown_service_provider_no_sp_name'          => 'Erro - Serviço desconhecido',
    'error_unknown_service_provider_desc'     => '%spName% a que pretende autenticar-se é desconhecido para a %suiteName%. Possivelmente a %idpName% nunca permitiu o acesso a este serviço. Entre em contacto com o suporte da %idpName% e fornecer-lhes as seguintes informações:',
    'error_unknown_service_provider_desc_no_sp_name'     => 'O serviço a que pretende autenticar-se é desconhecido para a %suiteName%. Possivelmente a %idpName% nunca permitiu o acesso a este serviço. Entre em contacto com o suporte da %idpName% e fornecer-lhes as seguintes informações:',
    'error_unknown_service_provider_desc_no_idp_name'     => '%spName% a que pretende autenticar-se é desconhecido para a %suiteName%. Possivelmente a sua %organisationNoun% nunca permitiu o acesso a este serviço. Entre em contacto com o suporte da sua %organisationNoun% e fornecer-lhes as seguintes informações:',
    'error_unknown_service_provider_desc_no_names'     => 'O serviço a que pretende autenticar-se é desconhecido para a %suiteName%. Possivelmente a sua %organisationNoun% nunca permitiu o acesso a este serviço. Entre em contacto com o suporte da sua %organisationNoun% e fornecer-lhes as seguintes informações:',
