...
return $overrides + [
    ...
    'wayf_no_access_helpdesk'   => 'Je kunt toegang vragen tot deze applicatie.  We sturen deze aanvraag door naar de helpdesk van je %orgNoun%.',
    ...
    'consent_reject_text_skeune_header'    => 'Je wilt geen gegevens delen met deze applicatie',
    'consent_reject_text_skeune_body'    => 'De applicatie waar je bij wilt inloggen heeft deze gegevens nodig om te kunnen functioneren.  Indien je verkiest om je data niet te delen, kan je de applicatie niet gebruiken.  Door je browser of door deze tab te sluiten verhinder je dat je informatie gedeeld wordt.  Mocht je later van gedachten veranderen, dan kun je opnieuw inloggen bij deze applicatie en krijgt je dit scherm opnieuw te zien.',
    'consent_nok_title'     => "Je wilt geen gegevens delen met deze applicatie",
    'consent_nok_text'      => "De applicatie waarop je wilt inloggen heeft deze gegevens nodig om te kunnen functioneren.  Indien je verkiest om je gegevens niet te delen, kan je de applicatie niet gebruiken.  Door je browser of door deze tab te sluiten verhinder je dat je informatie gedeeld wordt.  Mocht je later van gedachten veranderen, dan kan je opnieuw inloggen bij deze applicatie en krijg je dit scherm opnieuw te zien.",
