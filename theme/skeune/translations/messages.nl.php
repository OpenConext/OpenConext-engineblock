...
return [
    ...
    'wayf_noscript_warning_intro'     => 'Zonder JavaScript kun je geen vorig gebruikte accounts onthouden en niet zoeken.  Indien je deze functionaliteit toch wenst te gebruiken, vragen wij je vriendelijk om JavaScript aan te zetten.',
    ...
    'wayf_noaccess_title_screenreader'       => 'Vraag toegang voor dit account',
    ...
    'consent_identifier_explanation'    => 'De id voor deze dienst wordt gegenereerd door %suite_name% en is verschillend voor elke dienst waarvan gebruik maakt via %suite_name%. De dienst kan je daaraan herkennen als je later terugkeert.  Diensten kunnen je echter niet herkennen als dezelfde gebruiker wanneer zij gegevens uitwisselen.',
    'consent_provided_by'   => 'aangeboden door',
    'consent_tooltip_screenreader'  => 'Waarom hebben we jouw %attr_name% nodig?',
    'consent_nojs'   => 'Het bedienen van tooltips / modals op deze pagina met het toetsenbord vereist. Als je alleen het toetsenbord wilt gebruiken, gelieve dan JavaScript in te schakelen voor deze functionaliteit.',
