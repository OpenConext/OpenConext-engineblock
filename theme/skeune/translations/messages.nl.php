...
return [
    ...
    'consent_slidein_reject_text_skeune_header'    => 'U wil geen gegevens delen met deze dienst',
    'consent_slidein_reject_text_skeune_body'    => 'De dienst waar u bij wil inloggen heeft deze gegevens nodig om te kunnen functioneren.  Indien u verkiest om uw data niet te delen, kan u de dienst niet gebruiken.  Door uw browser of door deze tab te sluiten verhinderd u dat uw informatie gedeeld wordt.  Mocht u later van gedacht veranderen, kan u opnieuw inloggen bij deze dienst en krijgt u dit scherm opnieuw te zien.',
