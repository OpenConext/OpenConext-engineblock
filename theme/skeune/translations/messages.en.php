...
return [
    ...
    'consent_nojs'   => 'Tooltips / modals on this page need JavaScript to work with the keyboard.  If you use a keyboard, please enable JavaScript if you wish to use this functionality.',
