...
export const preferredIdpsSectionSelector = '.wayf__preferredIdps';
export const remainingIdpsSearchLabelSelector = '.remainingIdps__searchLabel';
...
export const rememberChoicePerIdpClass = 'wayf__rememberChoice--perIdp';
export const rememberChoiceTooltipToggleId = 'rememberChoiceTooltip';
export const rememberChoiceTooltipToggleSelector = `#${rememberChoiceTooltipToggleId}`;
export const rememberChoiceTooltipValueSelector = `.tooltip__value[data-for="${rememberChoiceTooltipToggleId}"]`;
