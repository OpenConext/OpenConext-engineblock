                    ...
                    ->children()
                        ->arrayNode('wiki_links')
                            ->children()
                                ...
                                ->arrayNode('specified')
                                    ->arrayPrototype()
                                        ->info('Please specify an array of i18n language abbreviation keys, mapped to wiki links matching that language. Example: [en => https://wiki.example.com/page1, pt => https://wiki.example.pt/page1].')
                                        ->scalarPrototype()
                                            ->info('Provide a URI to the wiki page for this specific error page language combination. Please review the example in parameter.yml.dist')
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
