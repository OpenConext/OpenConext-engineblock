...
final class AuthenticationProcedureList implements Countable
{
    /**
     ...
     */
    public function add(AuthenticationProcedure $authenticationProcedure)
    {
        $newAuthenticationProcedures = $this->authenticationProcedures;
        $newAuthenticationProcedures[] = $authenticationProcedure;
