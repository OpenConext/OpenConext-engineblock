...
class ServiceProvider extends AbstractRole
{
    ...
    {
        return [
            'attributeReleasePolicy' => $this->attributeReleasePolicy,
            'assertionConsumerServices' => $this->assertionConsumerServices,
            'allowedIdpEntityIds' => $this->allowedIdpEntityIds,
            'allowAll' => $this->allowAll,
            'requestedAttributes' => $this->requestedAttributes,
            'supportUrlEn' => $this->supportUrlEn,
            'supportUrlNl' => $this->supportUrlNl,
            'supportUrlPt' => $this->supportUrlPt,
            'id' => $this->id,
            ...
            'displayNameNl' => $this->displayNameNl,
            'displayNameEn' => $this->displayNameEn,
            'displayNamePt' => $this->displayNamePt,
            'logo' => $this->logo,
            'organizationNl' => $this->organizationNl,
            'organizationEn' => $this->organizationEn,
            'organizationPt' => $this->organizationPt,
            'keywordsNl' => $this->keywordsNl,
            'keywordsEn' => $this->keywordsEn,
            'keywordsPt' => $this->keywordsPt,
            'workflowState' => $this->workflowState,
            'contactPersons' => $this->contactPersons,
            'nameIdFormat' => $this->nameIdFormat,
            'supportedNameIdFormats' => $this->supportedNameIdFormats,
            'singleLogoutService' => $this->singleLogoutService,
            'requestsMustBeSigned' => $this->requestsMustBeSigned,
