...
namespace OpenConext\EngineBlock\CompatibilityBundle\Http\Response;
...
{
    static function serializeIdentityProvider(IdentityProvider $identityProvider)
    {
        return json_encode(array(
            ...
            'contact_persons'         => array_map(function (ContactPerson $contactPerson) {
                return array(
            ...
            'shib_md_scopes'          => array_map(function (ShibMdScope $shibMdScope) {
                return array(
                    'regexp'  => (bool)$shibMdScope->regexp,
                    'allowed' => $shibMdScope->allowed,
                );
            }, $identityProvider->shibMdScopes),
            'single_sign_on_services' => array_map(function (Service $service) {
                return array(
