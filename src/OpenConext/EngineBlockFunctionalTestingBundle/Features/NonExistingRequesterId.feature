Feature:
  ...
  Scenario: User logs in via trusted proxy proxy proxy and sees consent for the proxy proxy proxy (2 level)
    Given SP "Step Up" is authenticating for misconfigured SP "Far SP"
     ...
     Then I should see "Request for release of your information"
      ...
      And I should not see "Loa Up"
      And I should see "JC SP"
