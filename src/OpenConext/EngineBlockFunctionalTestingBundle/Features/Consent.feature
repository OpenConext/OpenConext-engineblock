...
Feature:
  ...
  Scenario: The user can read why the application requires an attribute
    Given I log in at "Dummy-SP"
    And I pass through EngineBlock
    And I pass through the IdP
    Then the response should contain "Dummy-SP will receive"
  ...
  Scenario: The user sees the identifier section when nameid is persistent
    ...
    And I pass through EngineBlock
    And I pass through the IdP
    Then the response should contain "The identifier for this application is generated by"
  ...
  Scenario: The user sees the identifier section when nameid is transient
    ...
    And I pass through EngineBlock
    And I pass through the IdP
    Then the response should not contain "The identifier for this application is generated by"
  ...
  Scenario: The user sees the identifier of the end-SP when a trusted proxy is involved
    Given SP "Trusted Proxy" is authenticating for SP "Dummy-SP"
    And SP "Trusted Proxy" is a trusted proxy
    And SP "Trusted Proxy" signs its requests
    And SP "Trusted Proxy" uses the Transient NameID format
    And SP "Dummy-SP" uses the Persistent NameID format
    When I log in at "Trusted Proxy"
    And I pass through EngineBlock
    And I pass through the IdP
    Then the response should contain "The identifier for this application is generated by"

  Scenario: The user sees the identifier of the end-SP when a trusted proxy is involved, unspecified edition
    Given SP "Trusted Proxy" is authenticating for SP "Dummy-SP"
    And SP "Trusted Proxy" is a trusted proxy
    And SP "Trusted Proxy" signs its requests
    And SP "Trusted Proxy" uses the Persistent NameID format
    And SP "Dummy-SP" uses the Unspecified NameID format
    When I log in at "Trusted Proxy"
    And I pass through EngineBlock
    And I pass through the IdP
    Then the response should contain "urn:collab:person:engine-test-stand.openconext.org:test"
