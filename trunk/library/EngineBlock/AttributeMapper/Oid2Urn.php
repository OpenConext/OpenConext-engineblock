...
class EngineBlock_AttributeMapper_Oid2Urn extends EngineBlock_AttributeMapper_Abstract
{
    ...
    protected $_mapping = array(
        ...
        'urn:oid:1.3.6.1.4.1.1466.115.121.1.15' => 'urn:mace:terena.org:attribute-def:schacHomeOrganization', //Domain name of the home organization
    );

    public function __construct()
    {
        // Include the simplesamp oid2urn map to overwrite the standard set of maps
        require_once('SimpleSamlAttributemap/oid2urn.php');
