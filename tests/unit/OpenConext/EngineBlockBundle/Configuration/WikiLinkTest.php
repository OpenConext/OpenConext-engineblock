...
class WikiLinkTest extends UnitTest
{
    ...
    public function wiki_links_is_required_to_be_an_array($notArray)
    {
        ...
        new WikiLink($notArray, 'https://fallback.uri');
    }
     ...
     */
    public function fallback_must_be_a_non_empty_string($notString)
    {
        $this->expectException(InvalidArgumentException::class);

        new WikiLink(['en' => 'https://wiki.co.uk/page1'], $notString);
    }
    ...
    public function when_link_not_found_a_fallback_is_returned()
    {
        ...
        $this->assertEquals('https://wiki.co.uk', $link->getLink('es'));
