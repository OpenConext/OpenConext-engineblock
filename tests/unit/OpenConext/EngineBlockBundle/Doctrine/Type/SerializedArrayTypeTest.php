...
class SerializedArrayTypeTest extends TestCase
{
    private MySQLPlatform $platform;

    public static function setUpBeforeClass(): void
    {
        if (!Type::hasType(SerializedArrayType::NAME)) {
    ...
    {
        $type = Type::getType(SerializedArrayType::NAME);

        $result = $type->convertToDatabaseValue(null, $this->platform);

        // Mirrors DBAL 3 ArrayType: null is serialize()d to 'N;', never SQL NULL.
    ...
    #[Group('Doctrine')]
    #[Test]
    public function an_array_round_trips_correctly(): void
    {
        $type  = Type::getType(SerializedArrayType::NAME);
    ...
    public function serialized_null_from_database_converts_to_null(): void
    {
        ...
        // 'N;' is what old code stored when $logo / $certificates was null
