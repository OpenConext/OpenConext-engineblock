...
class Test_EngineBlock_Corto_Filter_Command_SetNameIdTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Test_EngineBlock_Corto_Filter_Command_SetNameIdMock
     */
    private $_command;

    public function setUp()
    {
        $command = new Test_EngineBlock_Corto_Filter_Command_SetNameIdMock();
