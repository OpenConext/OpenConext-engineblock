...
class Test_EngineBlock_Corto_Filter_Command_SetNameIdMock extends EngineBlock_Corto_Filter_Command_SetNameId
{
    ...
    {
        $mock = new Test_EngineBlock_UserDirectoryMock();
        $mock->setUser(
