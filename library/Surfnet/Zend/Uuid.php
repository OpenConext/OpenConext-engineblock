...
class Surfnet_Zend_Uuid_Exception extends Zend_Exception {}

class Surfnet_Zend_Uuid
{
    const MD5 = 3;
    const SHA1 = 5;
    ...
    {
        if (strlen($uuid) != 16) {
            throw new Surfnet_Zend_Uuid_Exception("Input must be a 128-bit integer.");
        }
        $this->bytes = $uuid;
    ...
    public static function generate ($ver = 1, $node = NULL, $ns = NULL)
    {
        ...
        switch ((int) $ver) {
            ...
            case 2:
                ...
                throw new Surfnet_Zend_Uuid_Exception(
