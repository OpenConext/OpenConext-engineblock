...
class EngineBlock_Corto_Exception_UserCancelledStepupCallout extends EngineBlock_Exception implements EngineBlock_Corto_Exception_HasFeedbackInfoInterface
{
    /**
     * @var array
     */
