...
class EngineBlock_Error_Report_Mail 
{
    ...
    const DEFAULT_SUBJECT_TEMPLATE = <<<TEMPLATE
[EngineBlock Error <?php EngineBlock_ApplicationSingleton::getInstance()->getApplicationEnvironmentId(); ?>] <?php echo \$exception->getMessage(); ?>
TEMPLATE;
